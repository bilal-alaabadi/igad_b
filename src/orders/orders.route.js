...
const app = express();
app.use(cors({ origin: "https://www.igadom.com" }));
...
router.post("/create-checkout-session", async (req, res) => {
  ...
  try {
    ...
    const data = {
      ...
      mode: "payment",
      products: lineItems,
      success_url: "https://www.igadom.com/SuccessRedirect?client_reference_id=" + nowId,
      cancel_url: "https://www.igadom.com/cancel",
      metadata: {
